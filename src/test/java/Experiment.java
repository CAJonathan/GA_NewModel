...
public class Experiment {
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            String outputFilePath = Factors.PATH_TO_RESOURCE + Factors.OUTPUT_FOLDER + Factors.DISTRIBUTION_ENERGY_PREFIX + Factors.REMAINING_ENERGY_PREFIX + Factors.DISTRIBUTION_LOCATION_PREFIX + Factors.OUTPUTFILE_NAME;
